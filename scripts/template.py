...
f = open(f"../src/main/kotlin/com/clouddjr/advent2024/Day{day}.kt", "w")
fileContent = f'''package com.clouddjr.advent2024
...
f = open(f"../src/test/kotlin/com/clouddjr/advent2024/Day{day}Test.kt", "w")
fileContent = f'''package com.clouddjr.advent2024

import com.clouddjr.advent2024.Resources.{loadResourceMethod}
...
res = requests.get(f"https://adventofcode.com/2024/day/{args.day}/input", cookies={'session': session})
